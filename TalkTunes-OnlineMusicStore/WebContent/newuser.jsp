...
<title>Registration | TalkTunes</title>
...
<body>
	<div class="login_form">
        ...
        <form action="newUser" method="POST">
            <fieldset>
				<tr>
					<td><p class="head_name">Register a new membership</p></td><br>
				</tr>
        
        		<tr>
          			<td><i class="fas fa-user"></i></td>
          			<td><input type="text" name="fullName" id="" placeholder="Full Name" required></td><br>
        		</tr>
				...
				<tr>
					<td>
						<label class="container">
							<p id="container">I agree to the <a href="">terms</a></p>
